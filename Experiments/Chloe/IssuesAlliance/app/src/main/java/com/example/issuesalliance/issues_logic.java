package com.example.issuesalliance;
...
//        }else{
        submit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                String urlIssue = "http://coms-309-sr-7.misc.iastate.edu:8080/issues";
                String urlans = "http://10.26.44.13:8080/issues/";
                JsonObjectRequest ansRequest = new JsonObjectRequest(Request.Method.GET, urlans, null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        try {
                            String str = response.toString();
