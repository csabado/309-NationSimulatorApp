package com.example.issuesalliances;
...
public class IssuesAlliances extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_issues_alliances);
        ...
        refresh.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                String url = "http://10.26.44.13:8080/issues/";
                ...
                String urlTestA = "http://10.26.44.13:8080/issues/A";
                ...
                JsonObjectRequest reqB = new JsonObjectRequest(Request.Method.GET, urlB, null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        try {
                            String str = response.toString();
...
//        }else{
        submit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                String urlOptionTest = "http://10.26.44.13:8080/issues/answer";
                ...
                String urlans = "http://coms-309-sr-7.misc.iastate.edu:8080/issues/ans";
                final TextView ans = (TextView) findViewById(R.id.tv_optionError);
                JsonObjectRequest reqans = new JsonObjectRequest(Request.Method.GET, urlans, null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        try {
                            String str = response.toString();
                            String rString = str.substring(19, str.length() - 1);
                            JSONObject issueDecision = new JSONObject((response.toString()));
                            String i = issueDecision.getString("ans");
                            ans.setText(i);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
